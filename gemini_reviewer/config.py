...
class Config:
    ...
    def get_review_prompt_template(self) -> str:
        ...
        - "reviewComment": Explique o problema de forma clara. Inicie o comentário com o símbolo adequado (❌, ⚠️ ou ✅). OBRIGATÓRIO: Logo após a explicação, exiba o código problemático em vermelho usando um bloco de código `diff` (exemplo: ```diff\\n- código errado aqui \\n```). NÃO inclua nenhum título de sugestão neste campo.
